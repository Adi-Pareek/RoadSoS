...
class SOSActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        safButton.setOnClickListener {
            countDownTimer?.cancel()
            Toast.makeText(this, "Glad you're safe! Monitoring continues.", Toast.LENGTH_LONG)
                .show()
            finish()
        }
    ...
    private fun fetchContactsFromFirebaseCloud() {
        ...
        firestoreManager.getEmergencyContacts(userId) { contacts, error ->
            if (contacts != null) {
                ...
                Log.d(
                    "SOSActivity",
                    "Cloud se ${contacts.size} contacts successfully load ho gaye."
                )
            } else {
    ...
    private fun sendSos() {
        ...
        try {
            ...
            smsStatus.text =
                "✅ SMS sent to ${emergencyContactsList.size} contacts"
            ...
            if (userId != null) {
                ...
                firestoreManager.logAccidentEvent(
                    userId,
                    "Severe",
                    crashLat,
                    crashLng
