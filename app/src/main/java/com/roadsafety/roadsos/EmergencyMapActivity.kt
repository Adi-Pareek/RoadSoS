    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toggleMapButton.setOnClickListener {
            if (!isSatellite) {
                ...
                toggleMapButton.text = "Street"
                isSatellite = true
            } else {
                map.setTileSource(TileSourceFactory.MAPNIK)
                toggleMapButton.text = "Satellite"
                isSatellite = false
            }
            map.invalidate()
        }
    ...
    private fun initMap() {
        ...
        fusedLocationClient.lastLocation.addOnSuccessListener { location ->
            if (location != null) {
                ...
                userMarker.icon = ContextCompat.getDrawable(this, org.osmdroid.library.R.drawable.person)
                ...
                locationCallback = object : LocationCallback() {
                    override fun onLocationResult(locationResult: LocationResult) {
                        ...
                        userMarker.position = GeoPoint(currentLatitude, currentLongitude)
                        map.invalidate()
                    }
                }
                ...
                HospitalService.loadNearbyHospitals(this, map, currentLatitude, currentLongitude)
                PoliceService.loadNearbyPoliceStations(this, map, currentLatitude, currentLongitude)
